...
<p align="center">
  <a href="https://www.npmjs.com/package/@ideashift/nestjs-passport-firebase" target="_blank">
    <img src="https://img.shields.io/npm/v/@ideashift/nestjs-passport-firebase" alt="Latest Version">
  </a>
  <a href="https://www.npmjs.com/package/@ideashift/nestjs-passport-firebase" target="_blank">
    <img src="https://img.shields.io/npm/l/@ideashift/nestjs-passport-firebase" alt="License">
  </a>
  <a href="https://www.npmjs.com/package/@ideashift/nestjs-passport-firebase" target="_blank">
    <img src="https://img.shields.io/npm/dt/@ideashift/nestjs-passport-firebase" alt="Total Downloads">
  </a>
</p>
...
```bash
npm install @ideashift/nestjs-passport-firebase
```
...
import { FirebaseAuthModule } from '@ideashift/nestjs-passport-firebase';
...
FirebaseAuthModule.register({
  ...
  cookieName: process.env.FIREBASE_COOKIE_NAME,
});
```
...
import { FirebaseAuthGuard } from '@ideashift/nestjs-passport-firebase';
...
import {
  DecodedIdToken,
  FirebaseStrategy,
} from '@ideashift/nestjs-passport-firebase';
